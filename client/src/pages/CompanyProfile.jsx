    ...
    <div className='container mx-auto p-5'>
      <div className=''>
        <div className='w-full flex flex-col md:flex-row gap-3 justify-between'>
          ...
          <p className="text-sm font-mono">{info?.about}</p>
          </div>
        ...
        <div className='w-full flex flex-col md:flex-row justify-start md:justify-between mt-4 md:mt-8 text-sm bg-blue-100 p-2 rounded'>
      ...
      <div className='w-full mt-20 flex flex-col gap-2 '>
        <p className="bg-gray-200 w-fit p-3 rounded ">Jobs Posted</p>

  ...
  return (
        ...
        {/* left side */}
        {
          ...
          <div className="w-full flex flex-wrap md:flex-row gap-2 items-center justify-between my-10">
            <div className="bg-[#bdf4c8] w-40 h-16 rounded-lg flex flex-col items-center justify-center">
              ...
              <p className="text-lg font-semibold text-gray-700">₹{job?.salary}LPA</p>
            </div>
          ...
          <div className="w-full flex gap-4 py-5">
            <CustomButton
              ...
              selected === "0" ? "bg-black text-white" : "bg-white text-black border border-gray-300"
               }`}
            />
            <CustomButton
              ...
              title='Company'
              containerStyles={`w-full flex items-center justify-center py-3 px-5 outline-none rounded-full text-sm ${
              selected === "1" ? "bg-black text-white" : "bg-white text-black border border-gray-300"
               }`}
            />
          </div>
    ...
    user && user?.accountType === "seeker" ? (
      ...
      <CustomButton
        ...
        containerStyles={`w-full flex items-center justify-center text-white ${user?.accountType!== "seeker" ? 'opacity-50 cursor-not-allowed bg-black ' : 'bg-black'} py-3 px-5 outline-none rounded-full text-base`}
      />
    )
  )}
</div>
      ...
      <p className="text-gray-500 font-semibold bg-slate-200 w-fit p-2 rounded-md mb-3">Similar Job Post</p>
